...
public class DmsDelivery implements Serializable {
    ...
    @Column(name = "warranty_taken")
    private String warrantyTaken;

    
    @Column(name = "exwarenty_startdate")
    private String exWarStartDt;
    
    @Column(name = "insurance_taken")
    private String insuranceTaken;
    
    
    
    
    @Column(name = "exwarenty_enddate")
    private String exWarEndDt;
